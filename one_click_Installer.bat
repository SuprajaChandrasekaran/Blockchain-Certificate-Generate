...
SET REPO_DOWNLOAD_URL=https://github.com/SuprajaChandrasekaran/Blockchain-Certificate-Generate/releases/download/v0.1.0/Certificate-Dapp.zip
SET REPO_NAME=Certificate_Dapp.zip
SET EXTRACTED_REPO_DIR=Certificate-Dapp
